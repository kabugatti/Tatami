...
export function GraphiQLInterface({ fetcher }: GraphiQLInterfaceProps) {
  if (!fetcher) {
    return (
      <div className="h-[600px] xl:h-full w-full border border-dashed border-gray-300 flex items-center justify-center rounded-md text-sm text-muted-foreground text-center px-4">
